...
$GLOBALS['TL_LANG']['tl_book']['location']     = array('Ort', 'Bitte geben Sie den Erscheingsort des Buches ein.');
...
$GLOBALS['TL_LANG']['tl_book']['tags']         = array('Tags', 'Kommagetrennte Liste von Tags für das Buch.');
$GLOBALS['TL_LANG']['tl_book']['cssID']        = array('CSS-ID/Klasse', 'Hier können Sie eine ID und beliebig viele Klassen eingeben.');
$GLOBALS['TL_LANG']['tl_book']['published']    = array('Buch veröffentlichen', 'Das Buch auf der Webseite anzeigen.');
$GLOBALS['TL_LANG']['tl_book']['root_chapter'] = array('Wurzelkapitel', '');
